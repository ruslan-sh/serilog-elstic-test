...
namespace RuslanSh.SerilogElasticTest.ConsoleClient
{
    ...
    public class BenchmarkLogger
    {
        ...
        public string LogMesage = "Log";

        [Benchmark]
        public void LogToFile() => _fileLogger.Information(LogMesage);

        [Benchmark]
        public void LogToElastic() => _elasticLogger.Information(LogMesage);

        [Benchmark]
        public void LogToRabbit() => _rabbitLogger.Information(LogMesage);
    }
}